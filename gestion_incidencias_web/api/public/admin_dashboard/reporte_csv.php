<?php
// Configuración del archivo reporte_csv.php
...
try { // Intenta exportar el CSV
    ReporteController::exportCsv(); // Exporta el CSV
} catch (\Throwable $e) { // Captura cualquier error
    Response::error("Error al generar CSV: " . $e->getMessage(), 500); // Error interno
}
